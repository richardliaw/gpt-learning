    ...
    *,
    ...
    if not is_llama3:
        ...
        weight_map = {
            ...
            'model.layers.{}.mlp.gate_proj.weight': 'layers.{}.ff.gate_proj.weight',
            "model.layers.{}.mlp.up_proj.weight": "layers.{}.ff.up_proj.weight",
            "model.layers.{}.mlp.down_proj.weight": "layers.{}.ff.down_proj.weight",
